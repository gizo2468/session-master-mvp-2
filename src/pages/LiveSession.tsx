                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      {inactiveTables.map((table) => {
                        ...
                        console.log('LiveSession - REBUILT Total Payout Logic for table:', table.id);
                        console.log('LiveSession - buyIn:', table.buyIn);
                        console.log('LiveSession - cashOut:', table.cashOut);
                        console.log('LiveSession - profitLoss:', profitLoss);
                        console.log('LiveSession - newTotalPayout (buyIn + profitLoss, min buyIn):', newTotalPayout);
