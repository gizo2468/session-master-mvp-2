...
export default function Index() {
  ...
  return (
    ...
    <div className="min-h-screen">
      <header className="bg-white dark:bg-card shadow-sm dark:shadow-black/20 relative z-10 header-safe pt-2">
        <div className="container mx-auto max-w-md px-4 pb-2">
