    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Loading your poker sessions...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="w-full space-y-4">
            ...
            {sessions.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground mb-6">Start your first poker session to begin tracking your performance.</p>
              </div>
            ) : null}
          </div>
        </div>
