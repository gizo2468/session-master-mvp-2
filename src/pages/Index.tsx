        ...
        <div className="flex flex-col items-center gap-0">
          ...
          <div className="relative flex justify-center -mt-36 mb-0">
            ...
            <button
              ...
              className="absolute bottom-[24%] left-[5%] z-10 rounded-full overflow-hidden transform transition-all hover:scale-105 active:scale-95 focus:outline-none"
              aria-label="Player Card"
            >
              <img src={chipPlayerCard} alt="Player Card" className="w-28 h-auto object-contain pointer-events-none" draggable={false} />
            </button>

            {/* Middle icon – Coach */}
            <button
              onClick={handleCoachChipClick}
              className="absolute bottom-[14%] left-1/2 -translate-x-1/2 z-10 rounded-full overflow-hidden transform transition-all hover:scale-105 active:scale-95 focus:outline-none"
              aria-label="Coach Network"
            >
              <img src={chipCoach} alt="Coach Network" className="w-28 h-auto object-contain pointer-events-none" draggable={false} />
            </button>

            {/* Right icon – My Notes */}
            <button
              onClick={() => setNotesModalOpen(true)}
              className="absolute bottom-[24%] right-[5%] z-10 rounded-full overflow-hidden transform transition-all hover:scale-105 active:scale-95 focus:outline-none"
              aria-label="My Notes"
            >
              <img src={chipMyNotes} alt="My Notes" className="w-28 h-auto object-contain pointer-events-none" draggable={false} />
            </button>
          </div>
