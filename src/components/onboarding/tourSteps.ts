...
export const TOUR_PATHS: Record<TourPathId, TourStep[]> = {
  'start-session': [
    ...
    },
    {
      ...
      title: 'Manage Table',
      body: "Add a rebuy when needed, save hands, or end the table when you're done playing.",
      interactive: true,
      route: '/session',
      compact: true,
      placement: 'above',
    ...
    {
      selector: '[data-tour="end-table-profit"]',
      title: 'Profit / Loss',
      body: 'We instantly calculate your result against your buy-in so you can see how the table went.',
      interactive: true,
      compact: true,
      route: '/session',
      placement: 'below',
    ...
    {
      selector: '[data-tour="end-table-notes"]',
      title: 'Notes (Optional)',
      body: 'Add quick notes about the table — dynamics, key hands, opponents, anything worth remembering.',
      interactive: true,
      compact: true,
      route: '/session',
      placement: 'above',
    },
    {
      ...
      body: 'Tap End Table to save everything and close this table.',
      interactive: true,
      compact: true,
      route: '/session',
      placement: 'above',
