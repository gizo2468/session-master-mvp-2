...
export const AllTimeChartDisplay: React.FC<AllTimeChartDisplayProps> = ({
  ...
  return (
    <div className="overflow-x-auto">
      <ChartContainer config={chartConfig} className={`h-64 w-full ${isDailyView ? 'min-w-[400px]' : isLast30DaysView ? 'min-w-[1400px]' : isMonthlyView ? 'min-w-[500px]' : isWeeklyView ? 'min-w-[800px]' : isTableMode ? 'min-w-[1600px]' : dataToDisplay.length > 20 ? 'min-w-[1200px]' : dataToDisplay.length > 10 ? 'min-w-[600px]' : 'min-w-[300px]'}`}>
