      ...
      <DialogContent className="max-w-4xl max-h-[90vh] p-0">
        ...
        <ScrollArea className="px-6 pb-6 max-h-[calc(90vh-100px)]">
          <div className="prose max-w-none">
            ...
            <h2 className="text-xl font-bold mt-6 mb-3">2. Do We Use Cookies?</h2>
            <p className="mb-4">
            ...
            <h2 className="text-xl font-bold mt-6 mb-3">3. Third-Party Cookies</h2>
            <p className="mb-4">
            ...
            <h2 className="text-xl font-bold mt-6 mb-3">4. Your Cookie Choices</h2>
            ...
            <h2 className="text-xl font-bold mt-6 mb-3">5. Updates to This Policy</h2>
            <p className="mb-4">
            ...
            <h2 className="text-xl font-bold mt-6 mb-3">6. Contact Us</h2>
