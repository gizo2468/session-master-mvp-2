...
const LiveSessionHeader: React.FC = () => {
  ...
  return (
    <header className="bg-white dark:bg-card shadow-sm dark:shadow-black/20 px-4 pb-4 sticky top-0 z-10 relative flex items-center justify-center header-safe pt-4">
      <button 
