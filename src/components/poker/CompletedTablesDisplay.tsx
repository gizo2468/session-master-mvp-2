  ...
  const handleDeleteTable = (tableId: string) => {
    ...
    try {
      ...
      toast({
        ...
        description: "There was a problem deleting the table. Please try again.",
        variant: "destructive"
      });
    }
      ...
      <AlertDialog open={!!deletingTableId} onOpenChange={() => setDeletingTableId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete this table? This action cannot be undone and will remove all associated data.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
            <AlertDialogAction 
              onClick={() => deletingTableId && handleDeleteTable(deletingTableId)}
